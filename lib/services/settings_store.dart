...
class SettingsStore {
  static const _keyPrefix = 'piano_settings_';
  ...
  Future<AppSettings> load() async {
    ...
    final accidentalsEnabled = prefs.getBool('${_keyPrefix}accidentalsEnabled');
  ...
  Future<void> save(AppSettings settings) async {
    ...
    await prefs.setString(
      '${_keyPrefix}rangePreset',
      settings.rangePreset.name,
    );
    await prefs.setDouble(
      '${_keyPrefix}displaySeconds',
      settings.displaySeconds,
    );
    await prefs.setBool(
      '${_keyPrefix}accidentalsEnabled',
      settings.accidentalsEnabled,
    );
